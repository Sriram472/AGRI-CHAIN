...
CREATE TABLE IF NOT EXISTS users (
    ...
    role ENUM('FARMER', 'TRADER', 'OFFICER', 'MANAGER', 'ADMIN', 'COMPLIANCE', 'AUDITOR') NOT NULL,
...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    audit_action ENUM('CREATE', 'READ', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'DOWNLOAD', 'UPLOAD', 'APPROVE', 'REJECT', 'EXPORT') NOT NULL,
...
('Admin User', 'admin@agrichain.com', '9876543210', '$2a$10$example_hash_1', 'ADMIN', 'ACTIVE'),
